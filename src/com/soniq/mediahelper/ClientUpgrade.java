...
public class ClientUpgrade {
	...
	public void showUpgradeTipsDialog(String message, boolean force) {
		...
		int w = DlnaUtils.dip2px(_context, 700);
		int h = DlnaUtils.dip2px(_context, 308);
	...
	private int installApk() {
		...
		DlnaUtils.execCmd("chmod 777 " + file.toString());
	...
	private void showDownloadDialog() {
		...
		int w = DlnaUtils.dip2px(_context, 700);
		int h = DlnaUtils.dip2px(_context, 360);
	...
	public String checkVersion() {
		try {
			String currentVersion = DlnaUtils.getVersionCode(_context);
